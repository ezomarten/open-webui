...
```bash
docker pull ghcr.io/farefore/open-webui-public-share:0.8.10-publicshare.10
```
...
```dotenv
OPEN_WEBUI_IMAGE=ghcr.io/farefore/open-webui-public-share:0.8.10-publicshare.10

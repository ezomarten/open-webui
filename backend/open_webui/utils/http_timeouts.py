    ...
    while True:
        try:
            if timeout_started and timeout_seconds is not None:
                ...
                if remaining <= 0:
                    raise asyncio.TimeoutError(get_stream_prelude_timeout_message(pre_meaningful_timeout_seconds))
            ...
            raise asyncio.TimeoutError(get_stream_prelude_timeout_message(pre_meaningful_timeout_seconds)) from exc

...
from urllib.parse import urlparse  # fork:public-link-settings
...
from open_webui.utils.public_share import validate_public_share_base_url  # fork:public-link-settings
...
ADMIN_CONFIG_KEYS = {
    ...
    'ENABLE_PUBLIC_CHAT_SHARING': 'ui.enable_public_chat_sharing',  # fork:public-link-settings
    'PUBLIC_SHARE_BASE_URL': 'ui.public_share_base_url',  # fork:public-link-settings
}
...
class AdminConfig(BaseModel):
    ...
    ENABLE_PUBLIC_CHAT_SHARING: bool = False  # fork:public-link-settings
    PUBLIC_SHARE_BASE_URL: str = ''  # fork:public-link-settings


@router.post('/admin/config')
async def update_admin_config(request: Request, form_data: AdminConfig, user=Depends(get_admin_user)):
    try:  # fork:public-link-settings
    ...
    updates['ui.public_share_base_url'] = public_share_base_url  # fork:public-link-settings — persist normalized value
    ...
    request.app.state.PUBLIC_SHARE_BASE_URL = public_share_base_url  # fork:public-link-settings
    request.app.state.PUBLIC_SHARE_HOST = (  # fork:public-link-settings

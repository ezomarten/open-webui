...
async def get_admin_config(request: Request, user=Depends(get_admin_user)):
    return {
        ...
        'ENABLE_PUBLIC_CHAT_SHARING': request.app.state.config.ENABLE_PUBLIC_CHAT_SHARING,  # fork:public-link-settings
        'PUBLIC_SHARE_BASE_URL': request.app.state.config.PUBLIC_SHARE_BASE_URL,  # fork:public-link-settings
    }

...
DEFAULT_CONFIG = {
    ...
    'ui.enable_public_chat_sharing': ENABLE_PUBLIC_CHAT_SHARING,  # fork:public-link-settings
    'ui.public_share_base_url': PUBLIC_SHARE_BASE_URL,  # fork:public-link-settings

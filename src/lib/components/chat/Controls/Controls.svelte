<script lang="ts">
	...
	const compactSectionButtonClass =
		'ow-settings-trigger w-full py-1 text-xs font-normal text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 transition cursor-pointer select-none';
		...
		<div class="space-y-1 dark:text-gray-200 text-sm py-0.5 px-0.5">
			{#if chatFiles.length > 0}
				<Collapsible
					...
					buttonClassName="ow-settings-trigger w-full"

...
<div
	class={layout === 'grid'
		? 'ow-settings-surface ow-settings-surface-compact grid grid-cols-1 gap-x-5 gap-y-1 pb-safe-bottom text-xs text-gray-600 dark:text-gray-400 sm:grid-cols-2 lg:grid-cols-3'
		: 'ow-settings-surface ow-settings-surface-compact space-y-1 pb-safe-bottom text-xs text-gray-600 dark:text-gray-400'}
>
	<div>
		<Tooltip
			content={$i18n.t(

...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
	...
	<div
		class="admin-settings-panel ow-settings-surface ow-settings-surface-admin ow-settings-surface-wide flex-1 mt-3 lg:mt-1 px-[16px] lg:pr-[16px] lg:pl-0 overflow-y-scroll scrollbar-hidden"
	>

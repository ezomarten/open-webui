	...
	<div class="flex-1 min-h-0 overflow-y-auto scrollbar-hover pr-1.5">
		{#if ENABLE_OPENAI_API !== null && ENABLE_OLLAMA_API !== null && connectionsConfig !== null}
			<AdminSettingSection first>
				<AdminSettingRow label={$i18n.t('OpenAI API')} className="ow-settings-row" let:labelId>
					<Switch
				...
				<AdminSettingRow label={$i18n.t('Ollama API')} className="ow-settings-row" let:labelId>
					<Switch

<script lang="ts">
	...
	let autoFormat = true; // upstream v0.11.4 autoformat
				...
				<div class=" w-full flex flex-col {loading ? 'opacity-20' : ''}">
					...
					>
						<div class="w-full min-w-0 flex items-center">
							...
							<input
								class="w-full min-w-0 bg-transparent text-xl font-medium outline-hidden sm:text-2xl {$mobile
									? 'ml-1'
									: ''}"
								type="text"
						...
						<div class="flex items-center gap-0.5 shrink-0">
							...
							<NoteMenu bind:autoFormat <!-- upstream v0.11.4 autoformat -->
